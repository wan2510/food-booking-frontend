...
const menuItems = [
    {
        ...
        tag: 'Món mới',
        details:
            'Ức gà tươi, sốt cay Hàn Quốc đặc trưng, tẩm bột giòn. 600 kcal',
    },
    {
        ...
        tag: 'Best Seller',
        details:
            'Đùi gà tươi, tẩm bột chiên giòn, giữ nguyên hương vị tự nhiên. 350 kcal',
    },
    {
        image: 'src/assets/image/burgerthitxongkhoibbq.jpg',
        name: 'Burger Thịt Xông Khói BBQ',
        description:
            'Bánh burger nhân thịt bò kết hợp với thịt xông khói và sốt BBQ đậm đà.',
        price: '70.000đ',
        tag: 'Best Seller',
        details:
            'Thịt bò nướng, thịt xông khói, sốt BBQ, rau tươi, phô mai cheddar. 500 kcal',
    },
];
